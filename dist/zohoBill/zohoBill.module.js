...
const zohoBill_controller_1 = require("./zohoBill.controller");
...
let zohoBillModule = class zohoBillModule {
};
zohoBillModule = tslib_1.__decorate([
    common_1.Module({
        controllers: [zohoBill_controller_1.zohoBillController],
        providers: [zohoBill_service_1.zohoBillService, user_service_1.UserService, organization_service_1.OrganizationService],
        imports: [typeorm_1.TypeOrmModule.forFeature([zohoBill_entity_1.zohoBill, organization_entity_1.Organization, company_entity_1.Company, token_entity_1.zohoToken, entity_entity_1.Entitie, user_entity_1.User, otp_entity_1.Otp, account_entity_1.Account, dashboardData_entity_1.dashboardData, salesOrderReview_entity_1.salesOrderReview]), mail_module_1.MailModule, mailTrigger_module_1.MailTriggerModule, product_module_1.ProductModule, category_module_1.CategoryModule, company_module_1.companyModule, entities_module_1.entitiesModule, tempuser_module_1.TempuserModule],
        exports: [zohoBill_service_1.zohoBillService, typeorm_1.TypeOrmModule.forFeature([zohoBill_entity_1.zohoBill])],
    })
], zohoBillModule);
exports.zohoBillModule = zohoBillModule;
//# sourceMappingURL=zohoBill.module.js.map