...
const parentSku_dto_1 = require("./parentSku.dto");
...
let parentSkuController = class parentSkuController {
    constructor(parentSkuService, zohoEmployeeService, PSkuProcessService, processService) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (user.roles) {
                if (user.roles.includes(prodoRoles_constants_1.UserRole.PRODO_ADMIN)) {
                    result = yield this.parentSkuService.findAll(query);
    ...
    findOne(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let batchItemProcess = yield this.PSkuProcessService.findAll({ where: { pSkuId: id } });
            let batchItemProcessIds = [];
            let batchItem = yield this.parentSkuService.findOne(id);
    ...
    save(role, req) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            let save = yield this.parentSkuService.save(role);
            if (save) {
    ...
    update(id, role, req) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (role.status == parentSku_entity_1.Status.DELETED) {
                throw new common_2.HttpException({
            ...
            let save = yield this.parentSkuService.update(id, role);
            if (save) {
    ...
    softDelete(id, req) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let save = yield this.parentSkuService.softRemove(id, req.user.id);
            if (save) {
    ...
    hardDelete(id, req) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (req.user.roles.includes('PRODO_ADMIN')) {
                let save = yield this.parentSkuService.hardRemove(id, req.user.id);
                if (save) {
    ...
    addPermissions(id, req, body) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (new Set(d).size !== d.length) {
                ...
                let save = yield this.parentSkuService.addFields(id, req.user.id, body);
                if (save) {
    ...
    editPermissions(id, req, body) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (new Set(d).size !== d.length) {
                ...
                let save = yield this.parentSkuService.editFields(id, req.user.id, body);
                if (save) {
...
], parentSkuController.prototype, "findAll", null);
tslib_1.__decorate([
    common_1.Get(':id'),
    common_1.UseGuards(internal_jwt_auth_guard_1.IJwtAuthGuard),
    ...
    tslib_1.__metadata("design:returntype", Promise)
], parentSkuController.prototype, "findOne", null);
tslib_1.__decorate([
    common_1.Post(),
    common_1.UseGuards(internal_jwt_auth_guard_1.IJwtAuthGuard),
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [parentSku_dto_1.CreateParentSkuDto, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], parentSkuController.prototype, "save", null);
tslib_1.__decorate([
    common_1.Patch(':id'),
    common_1.UseGuards(internal_jwt_auth_guard_1.IJwtAuthGuard),
    common_1.UsePipes(new common_1.ValidationPipe({ transform: true })),
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, parentSku_dto_1.UpdateParentSkuDto, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], parentSkuController.prototype, "update", null);
tslib_1.__decorate([
    common_1.Delete(':id'),
    common_1.UseGuards(internal_jwt_auth_guard_1.IJwtAuthGuard),
    ...
    tslib_1.__metadata("design:returntype", Promise)
], parentSkuController.prototype, "softDelete", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [String, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], parentSkuController.prototype, "hardDelete", null);
tslib_1.__decorate([
    common_1.Post('addFields/:id'),
    common_1.UseGuards(internal_jwt_auth_guard_1.IJwtAuthGuard),
    common_1.UsePipes(new common_1.ValidationPipe({ transform: true })),
    tslib_1.__param(0, common_1.Param('id')), tslib_1.__param(1, common_1.Request()), tslib_1.__param(2, common_1.Body(new common_1.ParseArrayPipe({ items: parentSku_dto_1.CreateFieldDto }))),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, Object, Array]),
    tslib_1.__metadata("design:returntype", Promise)
], parentSkuController.prototype, "addPermissions", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [String, Object, Array]),
    tslib_1.__metadata("design:returntype", Promise)
], parentSkuController.prototype, "editPermissions", null);
parentSkuController = tslib_1.__decorate([
    common_1.Controller('internal/parentSku'),
...
exports.parentSkuController = parentSkuController;
//# sourceMappingURL=parentSku.controller.js.map