...
let internalPurchaseOrderService = class internalPurchaseOrderService {
    constructor(zohoPurchaseOrderRepository, zohoTokenRepository) {
    ...
    find(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let check = yield this.zohoPurchaseOrderRepository.findOne({ where: { purchaseorder_id: id } }).then((res1) => {
                return res1;
            }).catch((err) => {
                return false;
            });
...
internalPurchaseOrderService = tslib_1.__decorate([
    common_1.Injectable(),
...
exports.internalPurchaseOrderService = internalPurchaseOrderService;
