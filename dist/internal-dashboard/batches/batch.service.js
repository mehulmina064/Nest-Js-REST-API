...
let batchService = class batchService {
    constructor(batchRepository, zohoTokenRepository) {
        this.batchRepository = batchRepository;
        this.zohoTokenRepository = zohoTokenRepository;
    }
    findOne(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let team = yield this.batchRepository.findOne(id);
            if (team) {
                return team;
            }
            else {
    ...
    save(role) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            role.status = batch_entity_1.Status.NotStarted;
            role.completionDate = "";
            role.fields = [];
            return yield this.batchRepository.save(role);
        });
    }
    softRemove(id, userId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let role = yield this.batchRepository.findOne(id);
            if (role) {
                let del = yield this.batchRepository.delete(id);
                if (del) {
                    return "Deleted successfully";
                }
                else {
                    return Promise.reject(new common_2.HttpException('Batch not Deleted', common_2.HttpStatus.INTERNAL_SERVER_ERROR));
                }
            }
            else {
                return Promise.reject(new common_2.HttpException('Batch not found', common_2.HttpStatus.BAD_REQUEST));
    ...
    update(id, updateRole) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let role = yield this.batchRepository.findOne(id);
            if (role) {
                let data = yield this.batchRepository.update(id, updateRole);
                let saveRole = yield this.batchRepository.findOne(id);
                return saveRole;
            }
            else {
                return Promise.reject(new common_2.HttpException('Batch not found', common_2.HttpStatus.BAD_REQUEST));
    ...
    findAll(query) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (query) {
                console.log(query);
                let data = yield this.batchRepository.findAndCount(query);
                return { data: data[0], count: data[1] };
            }
            else {
                let data = yield this.batchRepository.findAndCount();
                return { data: data[0], count: data[1] };
            }
        });
    }
    check(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let check = yield this.batchRepository.findOne(id).then((res1) => {
                return res1;
            }).catch((err) => {
                return false;
            });
    ...
    addFields(id, userId, fields) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let PG = yield this.batchRepository.findOne(id);
            if (PG) {
                ...
                yield this.batchRepository.update(PG.id, PG);
                return PG;
            }
            else {
                return Promise.reject(new common_2.HttpException('Batch not found', common_2.HttpStatus.BAD_REQUEST));
...
batchService = tslib_1.__decorate([
    common_1.Injectable(),
    tslib_1.__param(0, typeorm_1.InjectRepository(batch_entity_1.batch)),
